...
$query ="SELECT * from teacher_details WHERE id='$teacher_id'";
...
$query_for_student_profile_update="UPDATE `teacher_details`  SET `name`='{$name}',`faculty`='{$faculty}',`email`='{$email}',`address`='{$address}',`phone_no`='{$phone_no}',`lecture_class`='{$lecture_class}',`password`='{$password}' WHERE id='$teacher_id'";
